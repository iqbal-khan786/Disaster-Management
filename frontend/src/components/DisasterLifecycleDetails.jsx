...
export function DisasterLifecycleDetails({
  currentPhase,
  nodes,
  onOpenDispatch,
}) {
  ...
  const node1 =
    nodeList.find((n) => n.id === 1 || n.id === "1") || nodeList[0] || {};
  const node2 =
    nodeList.find((n) => n.id === 2 || n.id === "2") || nodeList[1] || {};
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            <div>
              ...
              >
                Multi-sensor monitoring detects flood & landslide risks before
            ...
            >
              ...
              <strong style={{ color: "#fff" }}>2.4 Hours Lead-Time</strong>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                Risk = (Rain×0.25) + (Soil×0.20) + (Vib×0.20) + (Flame×0.15) +
                (Smoke×0.10) + (Climate×0.10)
              </div>
              <div
                style={{
                  fontSize: "11px",
              ...
              >
                ...
                >
                  ...
                  <strong>
                    {node1.flameDetected ? "FLAME" : "CLEAR"} /{" "}
                    {node1.vibration ? "MOTION" : "STABLE"}
                  </strong>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <div>
                    <strong style={{ color: "#fff" }}>
                      Kumbhikota Community Hall
                    </strong>
                    <div style={{ fontSize: "10px", color: "#64748b" }}>
                      Elevation: 195m ASL • 800m
                    </div>
                  </div>
                  <span style={{ color: "#34d399", fontWeight: 700 }}>
                    Cap: 320
              ...
              >
                <Sun size={12} /> Solar Continuous Power: 24/7 Active Field
                Operation
              </div>
            </div>
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            <div>
              ...
              >
                Autonomous radio packets hop across mountains when cellular
                towers are down.
              </p>
            </div>
            <div
          ...
          >
            ...
            >
              ...
              >
                <div
                  style={{ fontSize: "9px", color: "#fca5a5", fontWeight: 800 }}
                >
                  DISASTER ZONE
                </div>
                <div
                  style={{ fontSize: "13px", fontWeight: 800, color: "#fff" }}
                >
                  Node 1: Kolnara
                </div>
              ...
              <div
                style={{ color: "#38bdf8", fontSize: "10px", fontWeight: 700 }}
              >
                5.8 km
              ...
              >
                <div
                  style={{ fontSize: "9px", color: "#fde68a", fontWeight: 800 }}
                >
                  RELAY NODE
                </div>
                <div
              ...
              <div
                style={{ color: "#34d399", fontSize: "10px", fontWeight: 700 }}
              >
                8.2 km
                <div style={{ fontSize: "14px" }}>➔ ➔</div>
                -82 dBm
              ...
              >
                <div
                  style={{ fontSize: "9px", color: "#a7f3d0", fontWeight: 800 }}
                >
                  HQ GATEWAY
                </div>
                <div
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            <div>
              ...
              >
                Incident commanders dispatch helicopters and rescue boats
                directly to GPS coordinates.
              </p>
            </div>
          </div>
