...
export function OverviewView({
  ...
  const avgRssi =
    nodeList.length > 0
      ? Math.round(
          nodeList.reduce((acc, n) => acc + (n.rssi || -65), 0) /
            nodeList.length,
        )
      : -65;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div>
        ...
        >
          ...
          >
            ...
            >
              {nodeList.length}{" "}
              <span style={{ fontSize: "13px", color: "#64748b" }}>Sector</span>
            </div>
          ...
          >
            ...
            <div
              style={{
                fontSize: "10px",
                color: activeAlertsCount > 0 ? "#fca5a5" : "#34d399",
              }}
            >
              {activeAlertsCount > 0
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    gatewayStatus === "ONLINE" ? "#10b981" : "#ef4444",
                }}
      ...
      <div>
        ...
        >
          ...
          >
            *Estimated risk scores computed via sensor fusion (Rain, Soil,
            Vibration, Flame, Smoke, Climate)
          </span>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                className={`risk-level-label risk-${(selectedNode.risk?.flood || "LOW").toLowerCase()}`}
                style={{
                  fontSize: "11px",
                  fontWeight: 800,
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <span style={{ fontSize: "10px", color: "#94a3b8" }}>
                    Soil Moisture & Slope Tremors
                  </span>
                </div>
              </div>
              <span
                className={`risk-level-label risk-${(selectedNode.risk?.landslide || "LOW").toLowerCase()}`}
                style={{
                  fontSize: "11px",
                  fontWeight: 800,
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <span style={{ fontSize: "10px", color: "#94a3b8" }}>
                    MQ-2 Gas Sensor & Flame IR (Nominal)
                  </span>
                </div>
              </div>
              <span
                className={`risk-level-label risk-${(selectedNode.risk?.fire || "LOW").toLowerCase()}`}
                style={{
                  fontSize: "11px",
                  fontWeight: 800,
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <span style={{ fontSize: "10px", color: "#94a3b8" }}>
                    High Wind & Torrential Surge
                  </span>
                </div>
              </div>
              <span
                className={`risk-level-label risk-${(selectedNode.risk?.cyclone || "LOW").toLowerCase()}`}
                style={{
                  fontSize: "11px",
                  fontWeight: 800,
            ...
            >
              ...
              >
                ...
                >
                  {selectedNode.risk?.cyclone === "CRITICAL"
                    ? "92%"
                    : selectedNode.risk?.cyclone === "HIGH"
                      ? "70%"
                      : "15%"}
                </span>
              </div>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <span
                  style={{
                    color: selectedNode.vibration ? "#f59e0b" : "#10b981",
                    fontWeight: 700,
                  }}
                >
      ...
      <div className="glass-panel" style={{ padding: "16px" }}>
        ...
        >
          ...
          <div className="glass-card" style={{ padding: "10px 12px" }}>
            ...
            >
              {selectedNode.rainMm || 0}{" "}
              <span style={{ fontSize: "11px", color: "#64748b" }}>mm/h</span>
            </div>
          ...
          <div className="glass-card" style={{ padding: "10px 12px" }}>
            ...
            >
              {selectedNode.smokeLevel || 0}{" "}
              <span style={{ fontSize: "11px", color: "#64748b" }}>PPM</span>
            </div>
            <span style={{ fontSize: "9px", color: "#64748b" }}>
              MQ-2 Gas Sensor
            </span>
          ...
          <div className="glass-card" style={{ padding: "10px 12px" }}>
            ...
            >
              {selectedNode.vibration
                ? `${selectedNode.vibrationFreq || 380} Hz (TREMOR)`
                : "0 Hz (NOMINAL)"}
            </div>
            <span style={{ fontSize: "9px", color: "#64748b" }}>
