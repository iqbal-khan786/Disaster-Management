      ...
      >
        <div>
          ...
          <p style={{ fontSize: "11px", color: "#94a3b8", margin: "3px 0 0" }}>
            Rayagada District Offline Mesh Topology • 6 Physical IoT Sensors
            Array & Diagnostics
          </p>
        </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Sector: {node.district || "Rayagada District"} • 6 Physical
                    Sensors Array
                  </div>
                </div>
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: "#38bdf8", fontWeight: 600 }}>
                    Semtech SX1278 LoRa (433MHz +20dBm)
                  </span>
                </div>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
                >
                  ...
                  >
                    Rainfall, Soil Moisture, MQ-2 Gas, Flame Optical, SW-420
                    Seismic, DHT22 Climate
                  </span>
                </div>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
                >
                  ...
                  <span style={{ color: "#10b981", fontWeight: 600 }}>
                    Active Continuous Sampling (1.5s Cycle)
                  </span>
                </div>
                <div
                  style={{ display: "flex", justifyContent: "space-between" }}
                >
                  ...
                  <span
                    style={{ color: "#a855f7", fontFamily: "JetBrains Mono" }}
                  >
                    DisasterGuard-Node1-v3.0
                  </span>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: "8px", marginTop: "auto" }}>
                ...
                >
                  <RefreshCw
                    size={12}
                    className={isPinging ? "pulse-circle" : ""}
                  />
                  <span>
                    {isPinging
                      ? "Transmitting RF Ping..."
                      : isAcked
                        ? "Ping Acknowledged (+8.5dB)"
                        : "Test RF Link Ping"}
                  </span>
                </button>
              </div>
