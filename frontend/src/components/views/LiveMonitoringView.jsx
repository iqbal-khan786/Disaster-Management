...
export function LiveMonitoringView({
  ...
  const soilMoisture = Number(
    currentNode.soilMoisture || currentNode.soil || 34.1,
  );
  const soilPts = Math.min(
    20,
  ...
  const smokeLevel = Number(
    currentNode.smokeLevel || currentNode.smoke || 17.3,
  );
  const smokePts = Math.min(
    10,
  ...
  const flameDetected = Boolean(
    currentNode.flameDetected || currentNode.flame_detected,
  );
  ...
  const climatePts = Math.min(
    10,
    Math.max(3, Math.round(climateScoreRatio * 10)),
  );
  ...
  const rawCalculatedScore =
    rainPts + soilPts + smokePts + flamePts + vibePts + climatePts;
  const averageSensorScore = Math.min(
    100,
    Math.max(15, Math.round(currentNode.riskScore || rawCalculatedScore)),
  );
  ...
  let conditionDesc =
    "All 6 physical environmental sensors are within safe baseline parameters. Standard automated monitoring active.";
  let rescueActionText = "Forward Nominal Status to Rescue Team";

  if (
    averageSensorScore >= 70 ||
    currentNode.riskScore >= 70 ||
    flameDetected ||
    (soilMoisture >= 85 && vibration)
  ) {
    ...
    conditionDesc =
      "CRITICAL THRESHOLD BREACHED: Multi-sensor fusion indicates severe imminent disaster risk. Immediate rescue mobilization required!";
    ...
    conditionDesc =
      "ELEVATED THREAT DETECTED: Moderate anomaly in rainfall intensity or soil saturation. Pre-alert advisory transmitted.";
      ...
      >
        <div>
          ...
          <p style={{ fontSize: "11px", color: "#94a3b8", margin: "3px 0 0" }}>
            High-Frequency Environmental & Geological Telemetry • 6 Physical IoT
            Sensors Array
          </p>
        </div>
      ...
      >
        <div>
          ...
          >
            ...
            >
              {sensorCondition} CONDITION ({averageSensorScore}% COMPOSITE
              AVERAGE)
            </span>
          </div>
          <div
          ...
          >
            <span>
              GPS: {currentNode.latitude?.toFixed(4)}°N,{" "}
              {currentNode.longitude?.toFixed(4)}°E
            </span>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              ...
              >
                Aggregated 6-Sensor Telemetry Index ➔ Evaluates 3 Conditions
                (Safe / Warning / Danger) ➔ Auto-Relays to NDRF/SDRF Rescue
                Command
              </p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            >
              <span
                ...
                className={sensorCondition === "DANGER" ? "sonar-cascade" : ""}
              />
        ...
        >
          ...
          >
            ...
            >
              <span
                style={{ fontSize: "11px", color: "#94a3b8", fontWeight: 700 }}
              >
                Computed Sensor Average Value:
              </span>
              <span
                style={{
                  fontSize: "20px",
            ...
            >
              ...
              >
                <div style={{ color: "#f59e0b", fontWeight: 700 }}>
                  💨 Smoke: {smokeLevel}PPM
                </div>
                <div style={{ color: "#94a3b8", fontSize: "9px" }}>
                  Weight: 10% ({smokePts} pts)
                </div>
              </div>
              ...
              >
                <div
                  style={{
                    color: flameDetected ? "#ef4444" : "#10b981",
                    fontWeight: 700,
                  }}
                >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <div
                style={{ fontSize: "12px", fontWeight: 800, color: "#ffffff" }}
              >
                Rescue Team Forwarding Destination:{" "}
                <span style={{ color: "#38bdf8" }}>
                  NDRF 3rd Battalion & Rayagada District Base (DEOC)
                </span>
              </div>
              <div style={{ fontSize: "10px", color: "#94a3b8" }}>
                Protocol:{" "}
                <b>
                  LoRa SX1278 433MHz Mesh Packet Relay + Automated CAD Dispatch
                  Bridge
                </b>
              </div>
            </div>
        ...
        {forwardSuccess && (
          ...
          >
            ...
            <span>
              ✅ SUCCESS: Telemetry data (Average: {averageSensorScore}%,
              Condition: {sensorCondition}) successfully forwarded to NDRF/SDRF
              Rescue Unit at {lastForwardedTimestamp}!
            </span>
          </div>
        )}
      </div>
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              <span
                style={{ fontSize: "13px", fontWeight: 800, color: "#f8fafc" }}
              >
          ...
          <div className="gauge-bar-track">
            <div
              ...
              style={{
                ...
                background:
                  (currentNode.rainMm || 0) > 80
                    ? "#ef4444"
                    : (currentNode.rainMm || 0) > 40
                      ? "#f59e0b"
                      : "#818cf8",
              }}
            />
          ...
          <div className="gauge-bar-track">
            <div
              ...
              style={{
                ...
                background:
                  (currentNode.soilMoisture || 0) > 85
                    ? "#ef4444"
                    : (currentNode.soilMoisture || 0) > 60
                      ? "#f59e0b"
                      : "#10b981",
              }}
            />
          ...
          <div className="gauge-bar-track">
            <div
              ...
              style={{
                ...
                background:
                  (currentNode.smokeLevel || 0) > 150
                    ? "#ef4444"
                    : (currentNode.smokeLevel || 0) > 60
                      ? "#f59e0b"
                      : "#10b981",
              }}
            />
        ...
        >
          ...
          <div
            style={{
              padding: "8px",
              borderRadius: "6px",
              background: currentNode.flameDetected
                ? "rgba(239, 68, 68, 0.15)"
                : "rgba(16, 185, 129, 0.1)",
        ...
        >
          ...
          >
            ...
            >
              {currentNode.vibration
                ? `${currentNode.vibrationFreq || 38} Hz`
                : "0 Hz"}
            </span>
            <span
            ...
            >
              {currentNode.vibration
                ? "⚡ Debris Shock Detected"
                : "Quiescent Baseline (Stable)"}
            </span>
          </div>
          ...
          <div
            style={{
              padding: "8px",
              borderRadius: "6px",
              background: currentNode.vibration
                ? "rgba(239, 68, 68, 0.15)"
                : "rgba(16, 185, 129, 0.1)",
        ...
        >
          ...
          <div style={{ fontSize: "10px", color: "#64748b", marginTop: "2px" }}>
            Barometric Dewpoint:{" "}
            {Math.round(
              (currentNode.temp || 24.5) -
                (100 - (currentNode.humidity || 75)) / 5,
            )}
            °C
          </div>
        </div>
