    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
      {nodeList.map((node) => {
        ...
        const cardBg = isEmerg
          ...
          : isWarn
            ? "linear-gradient(90deg, rgba(245, 158, 11, 0.08), rgba(30, 41, 59, 0.8))"
            : "rgba(30, 41, 59, 0.7)";
          ...
          >
            ...
            >
              <div>
                ...
                >
                  ...
                  >
                    <Navigation size={11} /> {Number(node.latitude).toFixed(4)}
                    °N, {Number(node.longitude).toFixed(4)}°E
                  </span>
                  <span>•</span>
                  <span
                    style={{
              ...
              >
                {node.riskLevel || "NORMAL"} ({Math.round(node.riskScore || 0)}
                /100)
              </div>
            </div>
            ...
            {isEmerg && (
              ...
              >
                ...
                <span
                  style={{ color: "#ef4444", animation: "pulse 1s infinite" }}
                >
                  ACTIVE
                </span>
              </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: 700,
                    color:
                      node.smokeLevel > 80 || node.smoke > 80
                        ? "#ef4444"
                        : "#f59e0b",
                    fontFamily: "JetBrains Mono",
                  }}
