...
export function DispatchModal({ node, isOpen, onClose, onConfirm }) {
  ...
  const lat =
    typeof node.latitude === "number" ? node.latitude.toFixed(4) : "19.1950";
  const lng =
    typeof node.longitude === "number" ? node.longitude.toFixed(4) : "83.3950";
  const soil =
    ...
    <div className="modal-overlay">
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <span style={{ fontWeight: 800, color: "#b33b3b" }}>
              {node.disasterType || "FLASH FLOOD"} (Threat Score:{" "}
              {Math.round(node.riskScore || 0)}/100)
            </span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          <label
            style={{ fontSize: "11px", fontWeight: 700, color: "#607587" }}
          >
          ...
          >
            ...
            <button
              ...
              style={{
                background:
                  unitType === "NDRF_ALL_TERRAIN" ? "#dcecf4" : "#f2f4f6",
