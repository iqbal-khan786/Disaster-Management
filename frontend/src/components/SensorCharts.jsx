  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span style={{ fontSize: "10px", color: "#64748b" }}>
            ({history.length} Live Samples Buffer)
          </span>
        </div>
      ...
      <div style={{ height: "220px", position: "relative", width: "100%" }}>
        {activeChartTab === "rain_soil" && (
          <Line data={rainSoilData} options={rainSoilOptions} />
        )}
        {activeChartTab === "smoke_vibe" && (
          <Line data={smokeVibeData} options={smokeVibeOptions} />
        )}
        {activeChartTab === "temp_hum" && (
          <Line data={tempHumidityData} options={tempHumidityOptions} />
        )}
        {activeChartTab === "risk_signal" && (
          <Line data={signalRiskData} options={signalRiskOptions} />
        )}
      </div>
    </div>
  );
